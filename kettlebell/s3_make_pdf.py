...
US Letter with 0.7 inch margins.

Heading anchors are slugified the same way GitHub does it, so
the links in the Contents section stay clickable in the
finished PDF.
...
Usage:
    ...
    python3 s3_make_pdf.py other.md
    python3 s3_make_pdf.py other.md out/other.pdf
